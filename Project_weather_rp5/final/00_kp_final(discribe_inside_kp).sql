 ...
 * 
 * п.с.: цикличная вставка ближе к концу, до нее есть много повторяющегося кода, не стал переделывать, чтобы были все виды вставок.
 */
-- -------------------------------------------------------------------------------------------------------------------
/* Состав КП:
 ...
 * вложенные запросы
 * сложные запросы с JOIN + UNION
 * попытка оптимизации запроса (проблема придумать неэффективный запрос)
 * 
 * 
 * Имена таблиц:
 * report_27 - отчет 27
